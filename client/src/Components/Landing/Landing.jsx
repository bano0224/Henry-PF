                ...
                <Carousel cols={5} rows={1} gap={10} loop style={{marginTop: '20px'}}>
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center' >
                            <Grid container justifyContent='center' component={Link} to='/limpieza'>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to={{pathname: "/", data: 'nariz' }}>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to='/perfumeria'>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to='/bebidas'>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to='/carnes'>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to='/congelados'>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to='/fiambre'>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to='/frutas'>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to='/lacteos'>
                    ...
                    <Carousel.Item>
                        <Grid container direction='column' alignItems='center'>
                            <Grid container justifyContent='center' component={Link} to='/mascotas'>
